"""
Attack implementation for both controlled smooth FFNs and trained
CIFAR-10 transformer FFN blocks:
...
python -m curvature_cryptanalysis controlled \
  --out-dir ./runs_unified/controlled_gelu_seed0 \
  --activation gelu --d 64 --m 128 --T 32 --probe-locations 4 \
  --hessian-mode finite_diff --fd-eps 1e-3 \
  --dict-init random --dict-restarts 3 \
  --dict-steps 3000 --fit-steps 1500 --seed 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    add_attack_args(c, default_fd_eps=1e-3, default_T=32)
